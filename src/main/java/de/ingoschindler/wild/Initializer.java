...
import de.ingoschindler.wild.entity.*;
...
public class Initializer {
    ...
    private void init() {
        ...
        Category r4 = newCategory(reh, "Rücken (ausgelöst)", 30.0, 2);
        Category r5 = newCategory(reh, "Blatt/Schulter (ausgelöst)", 14.0, 4);
        ...
        Category ws2 = newCategory(ws, "Keule (ausgelöst)", 24.0, 3);
        Category ws3 = newCategory(ws, "Rücken (am Knochen)", 25.0, 2);
        Category ws4 = newCategory(ws, "Rücken (ausgelöst)", 30.0, 2);
        Category ws5 = newCategory(ws, "Blatt/Schulter (ausgelöst)", 14.0, 4);
